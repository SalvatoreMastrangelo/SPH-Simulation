\section{Possibili Sviluppi Futuri}
    ...
    \subsection{Tensione Superficiale}
        ...
        che prevale a distanze maggiori rispetto alla forza di pressione, e che è trascurabile a 
    ...
    \subsection{Parallelizzazione mediante GPU}
        ...
        delle grandezze fisiche, ma essendo tale calcolo fortemente parallelizzabile, sarebbe possibile 
        ...
        più adatte e tecniche di calcolo di hash per ciascuna cella.
    ...
    \subsection{Trasposizione in 3D}
        ...
        di supporto di calcolo tra vettori. Un problema più complesso potrebbe porsi nell'utilizzo
        della griglia per i neighbor, che in 3D risulterebbe molto più dispendiosa in termini di memoria.