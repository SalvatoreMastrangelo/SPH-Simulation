\section{Equazioni Governanti}
    L'interazione tra particelle é di tipo locale, e si estende fino ad una distanza
    ...
    é una funzione ad area unitaria e decrescente con la distanza. Spesso é
    definita come:
    ...
    \begin{itemize}
        ...
        \item $V_j$ é il volume associato alla particella $j$.
        \item $A_j$ é il valore della grandezza fisica per la particella $j$.
    \end{itemize}  
